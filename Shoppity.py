...
p4 = 20    # หน่อไม้ เห็ดเข็มทองหมาล่า
...
# ---------- 4. คำนวณยอดรวมและค่าจัดส่ง ----------
total_qty = q1 + q2 + q3 + q4 + q5
subtotal = (q1 * p1) + (q2 * p2) + (q3 * p3) + (q4 * p4) + (q5 * p5)

# เกณฑ์ค่าจัดส่ง: ซื้อขั้นต่ำ 199 บาท ส่งฟรี (ถ้าน้อยกว่า คิด 40 บาท)
if subtotal >= 199:
    shipping = 0
else:
    shipping = 40
...
# เกณฑ์คูปองส่วนลด: ซื้อตั้งแต่ 5 ชิ้นขึ้นไป
if total_qty >= 5:
...
st.write("ชื่อ-นามสกุล เลขที่ ชั้น ม.4/...")
